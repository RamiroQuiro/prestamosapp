const showToast = (text,opciones={}) => {
    ...
    opciones={
     ...
     toast.className = `${opciones.background}  rounded-lg flex md:top-10 bottom-auto md:top-auto top-14 md:right-10 left-1/3 rigth-auto md:left-auto capitalize text-gray-200 shadow-lg leading-6 fixed z-50   px-5 py-2 text-xs items-center justify-center font-bold opacity-0`;
