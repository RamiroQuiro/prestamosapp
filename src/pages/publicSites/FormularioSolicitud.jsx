...
console.log(formularioSolicitud)
    ...
    const requiredFields = ["nombreApellido", "dni", "direccion", "email", "celular", "importe", "nCuotas"];
  ...
  return (
    <div className='w-full h-full flex items-stretch w-full'>

     {!isPrestamoSimulado? <form action="" class="flex flex-col w-full items-center justify-normal p-3 text-primary-texto animate-aparecer">
